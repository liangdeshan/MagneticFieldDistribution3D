function arrowHandle = arrow3D(pos, deltaValues, datacolor,colorCode, stemRatio)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [CX,CY,CZ] = cylinder(cylinderRadius,10);      
    ...
    headZ = headZ + Vp(3) + Z;
    %************************************************************************************************************    
    hStem = surf(stemX, stemY, stemZ,datacolor+0*stemZ, 'FaceColor', colorCode, 'EdgeColor', 'none'); 
    hold on;  
    hHead = surf(headX, headY, headZ,datacolor+0*headZ, 'FaceColor', colorCode, 'EdgeColor', 'none');
